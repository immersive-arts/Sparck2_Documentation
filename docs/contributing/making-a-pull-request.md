...
You can contribute to SPARCK by making a [pull request] that
...
documentation here to describe the process as it applies to SPARCK2
...
sequenceDiagram
  ...
  loop prepare
    ...
    SPARCK2 ->> fork: merge in any changes
    fork ->>+ PR: create draft PR
    PR ->> PR: review your changes
  end
```

1. The first step is that you create a fork of the SPARCK2
...
6. You should also keep an eye on changes in the SPARCK2 repository
...
8.  Review your work as if you were the reviewer and fix any issues with your
    ...
    documentation for SPARCK2, which you can find in the `docs`
    folder. You may also want to make sure that relevant examples from the
    [test bed repository] still build fine.

[test bed repository]: https://github.com/tecartlab/SPARCK_TestBed
...
2. Request a review from the maintainer, `@maybites`.
...
To make changes to SPARCK2, you would first fork one of its
...
[repository]: https://github.com/immersive-arts/Sparck2
...
up the original SPARCK2 repository as an `upstream` repository for
your local clone.
...
```bash hl_lines="4"
$ git remote -v
origin	git@github.com:<your_username>/Sparck2-fork.git (fetch)
origin	git@github.com:<your_username>/Sparck2-fork.git (push)
$ git remote add upstream https://github.com/immersive-arts/Sparck2.git
$ git remote -v
origin	git@github.com:alexvoss/Sparck2-fork.git (fetch)
origin	git@github.com:alexvoss/Sparck2-fork.git (push)
upstream	https://github.com/immersive-arts/Sparck2.git (fetch)
upstream	https://github.com/immersive-arts/Sparck2.git (push)
```
...
- The documentation of SPARCK2 itself. If you set up and run the
...
- Test with relevant examples from the [SPARCK2 Examples]
  repository.

[smoke tests]: https://en.wikipedia.org/wiki/Smoke_testing_(software)
[SPARCK2 Examples]: https://github.com/mkdocs-material/examples
...
If you contribute to SPARCK2 more often or just happen to be
...
5. **Do** ask yourself if what you are doing benefits the wider community and
   makes SPARCK2 a better product.
