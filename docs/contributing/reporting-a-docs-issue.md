...
If you have found an inconsistency or see room for improvement, please follow this guide to submit an issue on our [issue tracker].

  [issue tracker]: https://github.com/immersive-arts/Sparck2_Documentation/issues
...
- [Documentation issues](#documentation-issues)
  - [Issue template](#issue-template)
    ...
    - [Proposed change optional](#proposed-change-optional)
    - [Checklist](#checklist)
...
| <!-- --> | Example  |
| -------- | -------- |
| __Clear__ | Clarify social cards setup on Windows
| __Unclear__ | Missing information in the docs
| __Useless__ | Help
