...
!!! warning "Calibration Requirements"
    ...
    Spout textures arrive at SPARCK asynchronously. SPARCK checks for a new texture at the end of each frame-pass. On the chosen render-pass the texture is passed on for further processing.
