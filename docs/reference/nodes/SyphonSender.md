...
-   :material-clock-fast:{ .lg .middle } __Quick Start__
    ...
    Get started with SyphonSender in minutes
    
    [:octicons-arrow-right-24: Project Examples](../../start/examples/project_examples.md)

-   :material-file-document:{ .lg .middle } __Complementing__ **SyphonSender**

    ---
    * [:octicons-arrow-right-24: SyphonReceive](SyphonReceive.md) 
